...
{
    colLabel->setText(statusCol.arg(ui->textEdit->textCursor().columnNumber()));
    rowLabel->setText(statusRow.arg(ui->textEdit->textCursor().blockNumber()));
}
